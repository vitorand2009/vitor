        ...
        <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <div className="text-lg font-bold text-gray-900 truncate">
              {stats?.charuto_favorito?.nome || 'Nenhum'}
            </div>
            <p className="text-xs text-gray-500">
              {stats?.charuto_favorito?.count || 0} degustações
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      {topSabores.length > 0 && (
        <Card className="bg-white shadow-md">
          <CardHeader>
            ...
            <CardDescription>
              Os sabores mais comuns nas suas degustações
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {(!stats || stats.total_degustacoes === 0) && (
        <Card className="bg-white shadow-md">
          <CardHeader>
            ...
            <CardDescription>
              Comece adicionando charutos ao seu estoque e registrando suas degustações
            </CardDescription>
          </CardHeader>
          <CardContent>
